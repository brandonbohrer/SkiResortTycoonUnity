...
namespace SkiResortTycoon.Core
{
    ...
    public class LiftSystem
    {
        ...
        public int BaseCost { get; set; } = 15000;          // Base cost per lift
        public int CostPerTile { get; set; } = 300;         // Additional cost per tile length
        public int CostPerHeightUnit { get; set; } = 500;   // Additional cost per height unit
